...
class DeviceController extends BaseCrudController
{
    ...
    protected function resolvedFormFields(): array
    {
        return [
            ...
            ['name' => 'port', 'label' => 'Port WEB SDK', 'type' => 'number', 'default' => 80, 'help' => 'Isi 80 untuk WEB SDK SOAP. Port 4370 dipakai jika nanti memakai Standalone SDK.'],
            ['name' => 'comm_key', 'label' => 'Comm Key', 'type' => 'text', 'default' => '0'],
