...
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('reports/subjects', [ReportController::class, 'subjectReport'])->name('reports.subjects');
        Route::get('reports/lecturers', [ReportController::class, 'lecturerReport'])->name('reports.lecturers');
